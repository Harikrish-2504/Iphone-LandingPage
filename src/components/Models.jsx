...
import {gaussianBlur} from "three/examples/jsm/nodes/Nodes.js";
import {animateWithGsapTimeline} from "../utils/animations";
const Models = () => {
  const [size, setsize] = useState("small");
  const [model, setModel] = useState({
    title: "iPhone 15 Pro in Narural TItanium",
    color: ["#8F8A81", "#FFE789", "#6F6C64"],
    img: yellowImg,
  });

  // camea control for the model view
  const cameraControSmall = useRef();
